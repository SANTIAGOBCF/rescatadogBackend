...
@router.post('/token',auth=None, summary="Get token",description="Username and password are required" )
...
@router.post('/register',auth=None, summary="Register user",description="Fill all fields" )
